...
- There are 8 mising values for the mpg column and 6 missing values for the horsepower column.
...
ANSWER HERE
- Both functions return the same value and are used of the same purpose.
...
The values in the origin column represent the country of origin of the cars.
